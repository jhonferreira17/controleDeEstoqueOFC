package com.example.controledeestoque.adapter;
...
public class AdapterProduto extends RecyclerView.Adapter<AdapterProduto.MyViewHolder> {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            textProduto = itemView.findViewById(R.id.textNomeProduto);
            textEstoque = itemView.findViewById(R.id.textEstoqueProduto);
            textValor = itemView.findViewById(R.id.textValorProduto);
        }
    }
}
